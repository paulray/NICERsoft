...
for obsid in args.obsids:
    ...
    subprocess.call(['python', '/home/fhuynh/Documents/Practice_scripts/NICER_Plots_Creation/NICERsoft/scripts/master_plotter.py', '--eng','--sci', '--map','--filtall', '--emin', '0.3', '--emax', '10.0'] + fnames)
