...
parser.add_argument(
    "evfile", help="Name of event file to convert (must be barycentered)"
)
parser.add_argument(
...
parser.add_argument(
    "--force",
    help="Force processing even if not barycentered",
    default=False,
    action="store_true",
)
parser.add_argument(
    "--search",
    help="Do an FFT and search the data after creating it",
    default=False,
    action="store_true",
)
parser.add_argument(
    "--numharm", help="Number of harmonics to sum in search", default="2"
)
parser.add_argument("--zmax", help="Max z for acceleration search", default="50")
parser.add_argument(
    "--flo", help="Lowest freq (of highest harmonic) to search", default="0.02"
)
...
if args.search:
    ...
    if os.path.isfile("{0}_ACCEL_{1}.cand".format(base, args.zmax)):
        cmd = [
            ...
            "1",
            "-accelfile",
            "{0}_ACCEL_{1}.cand".format(base, args.zmax),
