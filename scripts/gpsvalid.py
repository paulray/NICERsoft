...
for fn in filenames:
    ...
    sol = "{0}: SPS_VALID (0 = {1}, 1= {2}), SPS_TIME_VALID (0 = {3}, 1 = {4})".format(fn[48:71],  
'{0:03}'.format(zerocount), '{0:03}'.format(onecount), '{0:03}'.format(TIMEzerocount), '{0:03}'.format(TIMEonecount))
